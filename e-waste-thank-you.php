                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        ...
                        <div class="hero-content text-center">
                            <h3 class="sub-title" data-aos-delay="600" data-aos="fade-up">WE PROVIDE SUSTAINABLE RECYCLING SOLUTIONS</h3>
                            <h2 class="title" data-aos="fade-up" data-aos-delay="800">Thank You</h2>
                            <p data-aos="fade-up" data-aos-delay="900">We will contact you shortly and will help you with a tailored e-waste recycling plan for your organization.</p>
                            <div class="hero-btn" data-aos="fade-up" data-aos-delay="1000">
                                <a class="btn" href="http://bwmrecycle.com/">Back to Website</a>
                            </div>
                        </div>
                        <!-- Hero Content End -->
                    </div>
